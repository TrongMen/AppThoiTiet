    ...
    <View style={styles.container}>
          ...
          <View style={{flex:0.05,paddingLeft:'4%',paddingTop:'2%'}}>
            ...
            <View style={{flex:0.2,alignItems:'center'}}>
              <Text style={{fontSize:46,fontWeight:'bold',color:"white"}}>22&#176;</Text>
              <Text style={{fontSize:30,fontStyle:'italic',color:"white"}}>Trời nhiều mây</Text>
            </View>
            ...
            <View style={styles.box}>
              ...
              <View style={styles.box}>
                <Text style={{alignSelf:'center',fontSize:18,color:'white',marginBottom:20}}> 17:15</Text>
                <Image style={{width:60,height:55,alignItems:'center'}} source={require('../assets/Rain.png')} ></Image>
                
                <Text style={{alignSelf:'center',fontSize:18,color:'white',marginTop:20}}>23&#176;</Text>
              </View>
              <View style={styles.box}>
                <Text style={{alignSelf:'center',fontSize:18,color:'white',marginBottom:20}}> 17:30</Text>
                <Image style={{width:60,height:55,alignItems:'center'}} source={require('../assets/Rain.png')} ></Image>
